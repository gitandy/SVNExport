...
class BuildExe:
    def __init__(self):
        ...
        #Version of program
        self.project_version = svnexport.__version__[1:]
 
        #License of the program
        self.license = svnexport.__license__
 
        #Auhor of program
        self.author_name = svnexport.__author_name__
        self.author_email = svnexport.__author_email__
        self.copyright = svnexport.__copyright__

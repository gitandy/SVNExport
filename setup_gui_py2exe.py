...
class BuildExe:
    def __init__(self):
        ...
        #Version of program
        self.project_version = SVNExportGUI.__version__[1:]
 
        #License of the program
        self.license = SVNExportGUI.__license__
 
        #Auhor of program
        self.author_name = SVNExportGUI.__author_name__
        self.author_email = SVNExportGUI.__author_email__
        ...
        self.extra_datas = [self.icon_file]
